    ...
    >
      ...
      <div className="px-4 py-4 border-t border-white/5 flex flex-col gap-3">
        ...
        <a
          ...
          className="w-full py-2.5 text-[13px] font-semibold text-gray-500 border border-white/10 rounded-xl hover:border-white/20 hover:text-gray-300 transition-colors flex items-center justify-center gap-2"
        >
